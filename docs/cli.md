...
- **Commit sem IA por configuração**: se todos os arquivos staged corresponderem a `commit.no_ai_extensions`/`commit.no_ai_paths`, o Seshat gera mensagem automática `docs: update ...`.
