...
- [ ] `site/content/ui-contract.md` reflete a UI atual.
- [ ] `site/content/json-contract.md` reflete eventos JSONL atuais.
- [ ] `site/content/parity-matrix.md` nao tem lacunas sem card.

## Separacao Python x Rust

- [x] Escolher estrategia do card `021-python-cutover.md`: repos separados por linguagem.
- [x] Registrar fonte de verdade da implementacao Rust em `site/content/cutover-decision.md`.
