		...
		<main className="marketingPage">
			...
			<section id="top" className="hero">
				...
				<div className="heroContent">
					...
					<h1>Seshat</h1>
					<p>
						Automatize commits com Conventional Commits, checks por arquivo e um modelo local pronto
						para rodar no Ollama.
					</p>
			...
			<section className="terminalBand" aria-label="Exemplo do terminal">
				<div className="terminalCopy">
					...
					<a
						...
						href="https://github.com/juniormartinxo/seshat"
						target="_blank"
						rel="noreferrer"
					>
...
[ok] Sucesso: fix(tooling): foca teste criado`}</pre>
			...
			<section className="modelBand" id="model">
				<div>
					...
					<p>
						Um modelo treinado para receber `git diff` e devolver uma mensagem de commit direta, em
						PT-BR e no formato Conventional Commits.
					</p>
				</div>
